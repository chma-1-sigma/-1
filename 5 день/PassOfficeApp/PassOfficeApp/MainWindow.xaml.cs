...
namespace PassOfficeApp
{
    public partial class MainWindow : Window
    {
        ...
        {
            contentFrame.Navigate(new PersonalRequestPage(_db, _currentUser.id));
        }

        private void GroupButton_Click(object sender, RoutedEventArgs e)
        {
            contentFrame.Navigate(new GroupRequestPage(_db, _currentUser.id));
        }
        ...
        private async void MyRequestsButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            contentFrame.Navigate(new MyRequestsPage(requests));
        }
    }
}